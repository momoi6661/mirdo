...
func _init() -> void:
	...
	_require(root.has_node("RightPanel/RightPanelMargin/RightPanelBox/DetailOrnament"), "detail card should use a decorative ornament instead of info chips")
	_require(not root.has_node("RightPanel/RightPanelMargin/RightPanelBox/LootChipStrip"), "detail card should not use loot chip strip")
	_require(not root.has_node("RightPanel/RightPanelMargin/RightPanelBox/PreviewStrip"), "detail card should not keep the old color preview strip")
