...
const ANIM_PATH := "res://resources/animate/Kimodo/mirdo_stand_to_walk.res"
const FPS := 30.0

var important := {
	"Hips": 3.0,"Spine": 1.5,"Chest": 1.5,"UpperChest": 1.2,"Head": 1.0,
	"LeftUpperArm": 1.1,"LeftLowerArm": 1.1,"RightUpperArm": 1.1,"RightLowerArm": 1.1,
	"LeftUpperLeg": 2.5,"LeftLowerLeg": 2.5,"LeftFoot": 2.2,
	"RightUpperLeg": 2.5,"RightLowerLeg": 2.5,"RightFoot": 2.2,
}
...
func _init():
	...
	print("ANIM=", ANIM_PATH, " length=", anim.length, " key_last=", last, " loop=", anim.loop_mode, " tracks=", anim.get_track_count())
	print("time rootZ deltaZ/frame poseDelta")
