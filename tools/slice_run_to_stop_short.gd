...
const SRC_PATH := "res://resources/animate/Kimodo/run_to_stop.res"
const OUT_PATH := "res://resources/animate/Kimodo/run_to_stop_short.res"
const CUT_START := 0.36666666666667
const CUT_END := 2.5
const EPS := 0.00001
...
func _init():
	...
	print("SAVE err=", err, " path=", OUT_PATH, " source_cut=", CUT_START, "..", CUT_END, " length=", dur, " tracks=", out.get_track_count())
